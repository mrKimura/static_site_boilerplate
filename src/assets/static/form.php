<?php
    ...
    $address = "maxuscondoms@spectrumnutrition.ru";
    //откуда слать
    $from = "post@specrtumnutrition.ru";
    ...
    if (empty($error)) {
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            <head>
                ...
                <title>Почта с сайта MAXUS</title>
                <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
            </head>
            <body style="margin: 0; padding: 0;">
                <h2>Получено новое сообщение с сайта MAXUS.</h2>
